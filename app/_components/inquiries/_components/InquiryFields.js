...
function BooleanField({ form, label, name, onUpdate }) {
  return (
  ...
  return (
    <form className="inquiryForm" onSubmit={onSubmit}>
      ...
      <section className="inquiryFormSection">
        ...
        <BooleanField form={form} label="야근 여부" name="overtime" onUpdate={onUpdate} />
        <BooleanField form={form} label="내방객 유무" name="has_visitors" onUpdate={onUpdate} />
        <BooleanField form={form} label="인테리어 유무" name="has_interior" onUpdate={onUpdate} />
      </section>
